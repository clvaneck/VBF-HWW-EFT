...
input = glob.glob('/project/atlas/users/cvaneck/SampleGeneration/Process/HWWOffshellEFT-ggF/100004-i-or-q/EVNT/100004.EVNT.ROOT')
...
rivet.CrossSection =  7.5e-05 # unit = nb
job += rivet 

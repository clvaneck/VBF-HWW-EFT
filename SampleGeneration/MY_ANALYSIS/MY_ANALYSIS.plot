...
BEGIN PLOT .*/MY_ANALYSIS/jet_pT.*
Title=Transverse momentum of the leading jet
XLabel=$p_T^{jet}$ [GeV]
YLabel=$\frac{\mathrm{d}\sigma}{\mathrm{d}p_T^{jet}}$
END PLOT
